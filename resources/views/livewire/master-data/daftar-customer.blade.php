<div>
    <section class="section">
        <div class="section-header tw-rounded-none lg:tw-rounded-lg tw-shadow-md tw-shadow-gray-300 px-4">
            <h1 class="tw-text-lg mb-1">Daftar Customer</h1>
        </div>
                ...
                <form>
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="nama_customer">Nama Lengkap <span class="text-danger">*</span></label>
                            <input type="text" wire:model="nama_customer" id="nama_customer" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="hp_customer">Nomor HP <span class="text-danger">*</span></label>
                            <input type="text" wire:model="hp_customer" id="hp_customer" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="alamat_customer">Alamat</label>
                            <textarea wire:model="alamat_customer" id="alamat_customer" class="form-control"
                                style="height: 50px !important;"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="deskripsi_customer">Deskripsi</label>
                            <textarea wire:model="deskripsi_customer" id="deskripsi_customer" class="form-control"
